...
- In above case, we have 4 test cases; for the first test case, there are 2 boxes; for the first box, the width, the length and the height of each box is 43, 23, 45, accordingly.
